...
fn find_match_char_ranges(text_chars: &[char], query_lower: &[Vec<char>]) -> Vec<Range<usize>> {
...
fn content_span_start(spans: &[Span<'_>]) -> usize {
...
fn overlapping_ranges(ranges: &[Range<usize>], start: usize, end: usize) -> bool {
