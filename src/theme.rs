...
pub(crate) struct UiTheme {
    ...
    pub(crate) status_search_error_fg: Color,
    pub(crate) status_search_match_fg: Color,
...
pub(crate) struct MarkdownTheme {
    ...
    pub(crate) heading_marker: Color,
...
pub(crate) const ARCTIC_THEME: AppTheme = AppTheme {
    ...
    ui: UiTheme {
        ...
        status_search_bg: Color::Rgb(235, 238, 226),
        status_search_error_fg: Color::Rgb(188, 74, 74),
        status_search_match_fg: Color::Rgb(48, 140, 98),
    ...
    markdown: MarkdownTheme {
        ...
        heading_marker: Color::Rgb(116, 132, 152),
        heading_underline: Color::Rgb(160, 176, 194),
        code_frame: Color::Rgb(132, 148, 164),
        code_label: Color::Rgb(92, 116, 140),
        inline_code_fg: Color::Rgb(184, 112, 72),
        inline_code_bg: Color::Rgb(242, 232, 226),
...
pub(crate) const FOREST_THEME: AppTheme = AppTheme {
    ...
    ui: UiTheme {
        ...
        status_search_bg: Color::Rgb(30, 36, 34),
        status_search_error_fg: Color::Rgb(224, 120, 120),
        status_search_match_fg: Color::Rgb(132, 214, 154),
    ...
    markdown: MarkdownTheme {
        ...
        heading_marker: Color::Rgb(74, 98, 90),
        heading_underline: Color::Rgb(52, 68, 60),
        code_frame: Color::Rgb(50, 66, 60),
        code_label: Color::Rgb(128, 158, 142),
        inline_code_fg: Color::Rgb(238, 176, 130),
        inline_code_bg: Color::Rgb(46, 36, 30),
...
pub(crate) const OCEAN_DARK_THEME: AppTheme = AppTheme {
    ...
    ui: UiTheme {
        ...
        status_search_bg: Color::Rgb(26, 28, 42),
        status_search_error_fg: Color::Rgb(218, 95, 95),
        status_search_match_fg: Color::Rgb(115, 208, 148),
    ...
    markdown: MarkdownTheme {
        ...
        heading_marker: Color::Rgb(55, 75, 115),
        heading_underline: Color::Rgb(40, 50, 75),
        code_frame: Color::Rgb(40, 48, 68),
        code_label: Color::Rgb(95, 110, 145),
        inline_code_fg: Color::Rgb(235, 155, 115),
        inline_code_bg: Color::Rgb(40, 30, 28),
...
pub(crate) const SOLARIZED_DARK_THEME: AppTheme = AppTheme {
    ...
    ui: UiTheme {
        ...
        status_search_bg: Color::Rgb(12, 54, 62),
        status_search_error_fg: Color::Rgb(220, 50, 47),
        status_search_match_fg: Color::Rgb(133, 153, 0),
    ...
    markdown: MarkdownTheme {
        ...
        heading_marker: Color::Rgb(88, 110, 117),
        ...
        inline_code_bg: Color::Rgb(18, 52, 58),
